...
module Types.ResponseTypes (Response(..),
    ...
    Lab5OutputData(..), Lab5Response(..),
    Lab6OutputData(..), Lab6Response(..), Lab6EquationData(..)) where
...
data Lab4OutputData = Lab4OutputData
    { lab4IsSuccess       :: Bool
    , lab4ApproxName      :: String
    , lab4ApproxFormula   :: String
    , lab4Coefficients    :: [Double]
    , lab4DeviationS      :: Double
    , lab4StdDeviation    :: Double
    , lab4Determination   :: Double
    , lab4PearsonR        :: Double
    , lab4PhiValues       :: [Double]
    , lab4Residuals       :: [Double]
    , lab4ErrMessage      :: String
    } deriving (Show, Generic)

instance ToJSON Lab4OutputData

data Lab4Response = Lab4Response
    { lab4Info    :: Response
    , lab4Payload :: Lab4OutputData
    } deriving (Show, Generic)

instance ToJSON Lab4Response

data Lab4AllResponse = Lab4AllResponse
    { lab4AllInfo    :: Response
    , lab4AllPayload :: [Lab4OutputData]
    } deriving (Show, Generic)
...
data Lab6EquationData = Lab6EquationData
    { odeId     :: Int
    , odeString :: String
    , odeLatex  :: String
    , odeExactString :: String
    , odeExactLatex  :: String
    } deriving (Show, Generic)

instance ToJSON Lab6EquationData

data Lab6OutputData = Lab6OutputData
    { lab6IsSuccess    :: Bool
    , lab6MethodName   :: String
    , lab6OdeString    :: String
    , lab6OdeLatex     :: String
    , lab6Table        :: [(Double, Double, Double, Double)]
    , lab6RungeError   :: Double
    , lab6ErrMessage   :: String
    } deriving (Show, Generic)

instance ToJSON Lab6OutputData

data Lab6Response = Lab6Response
    { lab6Info    :: Response
    , lab6Payload :: Lab6OutputData
    } deriving (Show, Generic)

instance ToJSON Lab6Response